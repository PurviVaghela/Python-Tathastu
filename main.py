...
def run_alexa():
    jljwith sr.Microphone() as source:
...
try:
    ...
    if 'hello' in command:
        ...
        print("Today's Date is ", d2, 'Current time is', time) engine_talk('Today is : '+ d2)
        ...
        # Textual month, day and year
        d2 = today.strftime("%B %d, %Y")
        print("Today's Date is ", d2, 'Current time is', time) engine_talk( 'Current time is '+ time) engine_talk('and Today is : '+ d2)

    elif 'time' in command:
        time = datetime.datetime.now().strftime('%I:%M %p')
        print('The current time is' +time)
        engine_talk('The current time is') engine_talk(time)

    elif 'date' in command: today = date.today():
        ...
        print(_joke) engine_talk(_joke)

    elif 'search' in command :
        search = 'https://www.google.com/search?q='+command engine_talk('searching... ')
        webbrowser.open(search)
        ...
        url = 'https://google.nl/maps/place/'+loc+'/&amp;'
        webbrowser.get().open(url)
        print('Here is the location of '+loc) engine_talk('Here is the location of '+loc)
...
`       engine_talk('opening google..')
        ...
        engine_talk('your welcome')
         ...
         print('good bye, have a nice day !!')
        engine_talk('good bye, have a nice day !!') sys.exit()
        ...
        search = 'https://www.google.com/search?q='+command webbrowser.open(search)
